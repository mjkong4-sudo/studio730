      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F5F5EC] via-[#FCFAE9] to-[#F5F5EC]">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="animate-pulse">
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl p-8 space-y-7">
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F5F5EC] via-[#FCFAE9] to-[#F5F5EC]">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="mb-10 animate-fade-in">
          <h1 className="text-5xl font-bold text-[#5C7C5C] tracking-tight mb-3">Edit Record</h1>
          <p className="text-[#6B8E6A] text-xl font-medium">Update your Studio 730 record</p>
        </div>
        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl border border-[#5C7C5C]/10 p-8 sm:p-10 animate-fade-in">
          <form onSubmit={handleSubmit} className="space-y-7">
            ...
            <div className="group">
              <label htmlFor="date" className="flex items-center gap-2 text-sm font-bold text-[#5C7C5C] mb-3">
            ...
            <div className="group">
              <label htmlFor="gathering" className="flex items-center gap-2 text-sm font-bold text-[#5C7C5C] mb-3">
                <svg className="w-4 h-4 text-[#5C7C5C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="group">
              <label htmlFor="content" className="flex items-center gap-2 text-sm font-bold text-[#5C7C5C] mb-3">
                <svg className="w-4 h-4 text-[#5C7C5C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              ...
              <button
                type="button"
                onClick={() => router.back()}
                className="px-6 py-4 border-2 border-[#5C7C5C]/30 rounded-xl text-[#5C7C5C] hover:bg-[#5C7C5C]/10 transition-all duration-200 font-semibold shadow-sm hover:shadow"
              >
                Cancel
              </button>
            </div>
